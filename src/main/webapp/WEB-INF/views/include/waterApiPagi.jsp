...
<body>
	<article class="page-box">
		<ul class="page-body">
			...
			<a href="${rootPath }/fish/water?pageno=1">
			[처음]</li></a>
			
			<a href="${rootPath }/fish/water?pageno=${PAGE.nextPageNo}">	
			<li class="page-item" data-page="${PAGE.nextPageNo}">
			&lt;</li>
			</a> 

			<c:forEach begin="${PAGE.startPageNo }" end="${PAGE.endPageNo }" var="page">
			<a href="${rootPath }/fish/water?pageno=${page}">
			...
			<a href="${rootPath }/fish/water?pageno=${PAGE.finalPageNo}">	
